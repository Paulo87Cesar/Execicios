...
const addTechBtn = document.getElementById('btnTech')
const form = document.getElementById('devForm') 
const developer = []
let inputRows = 0

addTechBtn.addEventListener('click', function(ev){
    const satckInputs = document.getElementById('stackInputs')
    ...
    removeRowBtn.addEventListener('click', function(){
        satckInputs.removeChild(newRow)
    })
    ...
    satckInputs.appendChild(newRow)
})
